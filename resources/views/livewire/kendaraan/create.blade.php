<div>
    ...
    <x-card class="">
        ...
        <form method="POST" action="{{ route('kendaraans.store') }}" class="grid grid-cols-12 gap-4">
            @csrf
            <div class="col-span-6">
                <x-label for="no_plat" :value="__('No. Plat')" />

                <x-input id="no_plat" class="block mt-1 w-full" type="text" name="no_plat" :value="old('no_plat')" required autofocus />
            </div>
                ...
                >
                    @foreach ($pelanggans as $pelanggan)
                        <option 
                            ...
                            {{-- {{ (old('pelanggan_id') ? old('pelanggan_id') === $peran->pelanggan_id : $user->pelanggan_id === $peran->pelanggan_id ) ? 'selected' : '' }} --}}
            ...
            <div class="col-span-6">
                ...
                <x-input id="warna" class="block mt-1 w-full" type="tel" name="warna" :value="old('warna')" />
            </div>
