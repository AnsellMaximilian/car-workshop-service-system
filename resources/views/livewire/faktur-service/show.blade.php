        ...
        <div class="print-out relative">
            ...
            <div class="">
                ...
                <div class="mb-4 border-l border-r border-primary" >
                    ...
                    @foreach ($fakturService->service->penjualan_services as $penjualanService)
                        <div class="border-b border-primary grid grid-cols-12 py-2 gap-4">
                            ...
                            <div class="col-span-2 px-4">{{"Rp".number_format($penjualanService->harga, 0, ',', '.')}}</div>
                            <div class="col-span-2 px-4">{{$penjualanService->jumlah}}</div>
                            <div class="col-span-4 px-4">{{"Rp".number_format($penjualanService->getTotal(), 0, ',', '.')}}</div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="grid grid-cols-12 py-2 gap-4">
                    ...
                    <div class="col-span-4 col-start-9 pl-4">{{ "Rp".number_format($fakturService->service->getTotalPenjualanServices(), 0, ',', '.')}}</div>
                </div>
            </div>
            <hr class="my-4">
            @endif
            ...
            <div class="">
                ...
                <div class="mb-4 border-l border-r border-primary" >
                    ...
                    @foreach ($fakturService->service->penggantian_suku_cadangs as $penggantianSukuCadang)
                        <div class="border-b border-primary grid grid-cols-12 py-2 gap-4">
                            ...
                            <div class="col-span-2 px-4">{{"Rp".number_format($penggantianSukuCadang->harga, 0, ',', '.')}}</div>
                            <div class="col-span-2 px-4">{{$penggantianSukuCadang->jumlah}}</div>
                            <div class="col-span-4 px-4">{{"Rp".number_format($penggantianSukuCadang->getTotal(), 0, ',', '.')}}</div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="grid grid-cols-12 py-2 gap-4">
                    ...
                    <div class="col-span-4 col-start-9 pl-4">{{ "Rp".number_format($fakturService->service->getTotalPenggantianSukuCadangs(), 0, ',', '.')}}</div>
                </div>
            </div>
            <hr class="my-4">
            @endif
            ...
            <div class="grid grid-cols-12 py-2 gap-4">
                ...
                <div class="col-span-4 col-start-9 text-xl pl-4">{{ "Rp".number_format($fakturService->service->getGrandTotal(), 0, ',', '.') }}</div>
            </div>
        </div>
