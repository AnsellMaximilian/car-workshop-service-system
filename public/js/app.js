...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // Delete confirmation

document.querySelectorAll(".with-del-conf").forEach(function (button) {
  button.addEventListener("click", function (e) {
    ...
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      ...
      confirmButtonColor: "#b51919" // customClass: {
